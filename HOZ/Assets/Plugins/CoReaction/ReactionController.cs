...
namespace CoReaction
{
	public class ReactionController : MonoBehaviour
	{
		...
		public void AddParameter(int parameterID, ParameterType paramType, object initValue = null)
		{
			...
			{
				Debug.LogWarning("Coreaction, duplicate parameterID : " + parameterID);
				return;
			}
			...
			if (parameter == null)
			{
				Debug.LogWarning("Not found parameterTYpe : " + paramType);
				return;
			}
		...
		public void AddReaction (BaseReaction reaction)
		{
			if (reaction == null)
			{
				Debug.LogWarning("Null reaction !!!");
				return;
			}
			...
			for (int m = 0; m < conditionList.Count; m++)
			{
				...
				if (parameter == null)
				{
					Debug.LogWarning( "AddReaction, Not found parameterID : " + condition.parameterID);
					continue;
				}
		...
		void SetParameterValue(int parameterID, object value)
		{
			if (! _parameterDictionary.ContainsKey(parameterID))
			{
				Debug.LogWarning( "SetParameter, not found parameterID = " + parameterID);
				return;
			}
